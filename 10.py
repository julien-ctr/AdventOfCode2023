...
def part1(input: str) -> int:
    ...
    while len(to_treat) != 0:
        ...
        for neighbour in n:
            distances[neighbour[0]][neighbour[1]] = distances[node[0]][node[1]] + 1
...
def part2(input: str) -> int:
    ...
    while len(to_treat) != 0:
        ...
        for neighbour in n:
            distances[neighbour[0]][neighbour[1]] = 0  #Just set it to something other than -1 to show it has been treated
            to_treat.append(neighbour)
